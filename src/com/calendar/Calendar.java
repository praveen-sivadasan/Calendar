...

{
	...
	/*
	 * will declare few arrays to print the dates in a line simulateneously for 4
	 * months.
	 * 
	 */
	...
	void print_month(int day, int year) {
		...
		/*
		 * Now we have the day on which this year is starting .that is which day is
		 * jan1st.Aim in this function to print d numbers in order. s going from 1 to 3
		 * as we r printing months in order of 4
		 * 
		 */
		...
		for (int s = 1; s <= 4; s++) // loop for displaying month name
		{
			...
			int odd1_end = 0, feb_end = 0, odd2_end = 0, even1_end = 0, even2_end = 0; // to know whether all array
																						// elements r print till
																						// respective month end ie 31
																						// ?30 ?28?29

			int jvacc = 0, jstart = 0; // start for preventing loop to print vaccant place at beging again ie wen k1 =1
										// ,2 ...
	...
	void program() {
		...
		try {
			 ...
			 * calendar.next year jan1st 2013 has jan1st as TUESDAY.here 2 days increased as
			 * 1 increase for d year and 1(leap) for d leap year 2012.(feb got 29 days).
			 * next year 2014 has jan1st on WEDNESDAY,den 2015 THURSDAY.
			 * 
			 * leap_incr is used to find dat number of 1s in case of leap year. for ex:
			 * year=2016 den leap_incr=(2016/4)-(2012/4) = 1(for 2012) if year=2017 den
			 * leap_incr=(2017/4)-(2012/4)+ 1(for 2016)= 2(for both 2012 and 2016)
			 * 
			 */
